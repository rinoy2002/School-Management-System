...
public class TeacherForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 90, 30));
    ...
    private void jLabel7MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MousePressed
        ...
        try{
            ...
            if(pass1.equals(pass2)){
                ...
                String sql ="update teacher set password ='"+new_passwd+"' where teacher_id ='"+teacherid+"';";
                ...
                JOptionPane.showMessageDialog(null, "Invalid Teacher ID or Password Mismatch");
                teacher_id.setText("");
                repassword.setText("");
                password.setText("");
            }
