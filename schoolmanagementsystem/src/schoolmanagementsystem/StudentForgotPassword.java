...
public class StudentForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, 130, 30));
        ...
        jPanel2.add(admission_number, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, 240, 30));
    ...
    private void jLabel7MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MousePressed
        ...
        try{
            ...
            if(pass1.equals(pass2)){
                String admno=admission_number.getText();
                String new_passwd=password.getText();
                String sql ="update student set password ='"+new_passwd+"' where admission_number ='"+admno+"';";
                ...
                JOptionPane.showMessageDialog(null, "Invalid Admission Number or Password Mismatch");
                admission_number.setText("");
                repassword.setText("");
                password.setText("");
            }
